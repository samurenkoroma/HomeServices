...
VALUES (gen_random_uuid(), 'Инкас F1', 'tomato', 'Томат', 10.0, 30.0, 95, 12.0, 1.2, ARRAY ['spring', 'summer'],
       ...
       (gen_random_uuid(), 'Рио-Гранде', 'tomato', 'Томат', 10.0, 32.0, 110, 10.0, 0.8, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Белла Роса F1', 'tomato', 'Томат', 8.0, 28.0, 85, 9.0, 1.0, ARRAY ['spring'],
        ARRAY ['open_ground', 'greenhouse'],
       ...
       (gen_random_uuid(), 'Солероссо F1', 'tomato', 'Томат', 10.0, 32.0, 100, 11.0, 1.1, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Макан F1', 'tomato', 'Томат', 10.0, 30.0, 115, 14.0, 1.8, ARRAY ['spring', 'summer'],
        ARRAY ['greenhouse'],
       ...
       (gen_random_uuid(), 'Ямамото', 'tomato', 'Томат', 10.0, 28.0, 108, 13.0, 1.6, ARRAY ['spring', 'summer'],
        ARRAY ['greenhouse'],
       ...
       (gen_random_uuid(), 'Бычье сердце', 'tomato', 'Томат', 10.0, 30.0, 120, 8.5, 1.5, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground', 'greenhouse'],
       ...
       (gen_random_uuid(), 'Хурма', 'tomato', 'Томат', 10.0, 30.0, 115, 7.0, 1.2, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground', 'greenhouse'],
       ...
       (gen_random_uuid(), 'Черная гроздь', 'tomato', 'Томат', 10.0, 30.0, 95, 6.0, 1.5,
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Родничок F1', 'cucumber', 'Огурец', 12.0, 35.0, 48, 10.0, 1.8, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Бочковой F1', 'cucumber', 'Огурец', 12.0, 35.0, 50, 12.0, 2.0, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Нежинский', 'cucumber', 'Огурец', 12.0, 35.0, 55, 9.0, 1.5, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Криспина F1', 'cucumber', 'Огурец', 12.0, 35.0, 42, 14.0, 2.2, ARRAY ['spring', 'summer'],
        ARRAY ['greenhouse'],
       ...
       (gen_random_uuid(), 'Эколь F1', 'cucumber', 'Огурец', 12.0, 35.0, 45, 11.0, 1.9, ARRAY ['spring', 'summer', 'autumn'],
        ARRAY ['greenhouse'],
       ...
       (gen_random_uuid(), 'Мертус F1', 'cucumber', 'Огурец', 12.0, 35.0, 47, 13.0, 2.0, ARRAY ['spring', 'summer'],
        ARRAY ['greenhouse'],
       ...
       (gen_random_uuid(), 'Мадрилене F1', 'cucumber', 'Огурец', 12.0, 35.0, 44, 12.5, 2.1, ARRAY ['spring', 'summer'],
        ARRAY ['greenhouse'],
       ...
       (gen_random_uuid(), 'Гектор F1', 'cucumber', 'Огурец', 12.0, 35.0, 40, 8.0, 1.2, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Аякс F1', 'cucumber', 'Огурец', 12.0, 35.0, 46, 10.5, 1.7, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Слава 1305', 'cabbage', 'Капуста', 5.0, 25.0, 110, 7.0, 0.4, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Мегатон F1', 'cabbage', 'Капуста', 5.0, 25.0, 120, 12.0, 0.45, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Подарок', 'cabbage', 'Капуста', 5.0, 25.0, 115, 8.5, 0.4, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Менза F1', 'cabbage', 'Капуста', 5.0, 25.0, 125, 11.0, 0.5, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Краутман Амагер', 'cabbage', 'Капуста', 5.0, 25.0, 130, 9.0, 0.4,
       ...
       (gen_random_uuid(), 'Агрессор F1', 'cabbage', 'Капуста', 5.0, 27.0, 105, 10.0, 0.4, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Атрия F1', 'cabbage', 'Капуста', 5.0, 25.0, 108, 11.5, 0.45, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Белоснежка', 'cabbage', 'Капуста', 5.0, 25.0, 100, 6.5, 0.35, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Сторидор F1', 'cabbage', 'Капуста', 5.0, 25.0, 112, 9.5, 0.42, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Ринда F1', 'cabbage', 'Капуста', 5.0, 25.0, 100, 8.0, 0.4, ARRAY ['spring', 'summer', 'autumn'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Джинтама F1', 'cabbage', 'Капуста', 5.0, 25.0, 118, 10.5, 0.48, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Гала', 'potato', 'Картофель', 5.0, 28.0, 70, 4.5, 0.6, ARRAY ['spring'], ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Невский', 'potato', 'Картофель', 5.0, 28.0, 85, 5.0, 0.65, ARRAY ['spring'], ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Луговской', 'potato', 'Картофель', 5.0, 28.0, 95, 5.5, 0.7, ARRAY ['spring'],
        ARRAY ['open_ground'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Ладожский 101', 'corn', 'Кукуруза', 10.0, 35.0, 95, 8.0, 2.0, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Кубанская сахарная', 'corn', 'Кукуруза', 10.0, 35.0, 105, 9.0, 2.2,
        ARRAY ['spring', 'summer'], ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Добрыня', 'corn', 'Кукуруза', 10.0, 35.0, 100, 8.5, 1.9, ARRAY ['spring', 'summer'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Французский завтрак', 'radish', 'Редис', 4.0, 25.0, 22, 2.5, 0.15,
       ...
       (gen_random_uuid(), 'Красный великан', 'radish', 'Редис', 4.0, 25.0, 30, 3.0, 0.2,
       ...
       (gen_random_uuid(), 'Рондар F1', 'radish', 'Редис', 4.0, 25.0, 20, 3.5, 0.12, ARRAY ['spring', 'summer', 'autumn'],
        ARRAY ['open_ground', 'greenhouse'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Штутгартер Ризен', 'onion', 'Лук', 5.0, 30.0, 100, 5.0, 0.4, ARRAY ['spring'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Сеншуй', 'onion', 'Лук', 5.0, 30.0, 110, 4.5, 0.35, ARRAY ['spring'], ARRAY ['open_ground'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Любаша', 'garlic', 'Чеснок', 3.0, 28.0, 100, 3.5, 0.5, ARRAY ['autumn'], ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Украинский белый', 'garlic', 'Чеснок', 3.0, 28.0, 90, 3.0, 0.45, ARRAY ['spring'],
        ARRAY ['open_ground'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Вакула', 'barley', 'Ячмень', 3.0, 30.0, 85, 0.55, 0.8, ARRAY ['spring'], ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Приазовский', 'barley', 'Ячмень', 3.0, 30.0, 90, 0.6, 0.85, ARRAY ['spring'],
        ARRAY ['open_ground'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Алмаз', 'eggplant', 'Баклажан', 13.0, 32.0, 120, 6.0, 0.6, ARRAY ['spring', 'summer'],
        ARRAY ['open_ground', 'greenhouse'],
       ...
       (gen_random_uuid(), 'Черный красавец', 'eggplant', 'Баклажан', 13.0, 32.0, 110, 7.0, 0.7,
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Атлант', 'pea', 'Горох', 4.0, 28.0, 85, 0.35, 0.8, ARRAY ['spring'], ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Мадонна', 'pea', 'Горох', 4.0, 28.0, 75, 0.4, 0.7, ARRAY ['spring'], ARRAY ['open_ground'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Лидер', 'rapeseed', 'Рапс', 3.0, 30.0, 95, 0.25, 1.2, ARRAY ['spring'], ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Сальса', 'rapeseed', 'Рапс', 3.0, 30.0, 100, 0.3, 1.3, ARRAY ['spring'], ARRAY ['open_ground'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Вилана', 'soybean', 'Соя', 10.0, 35.0, 110, 0.3, 0.9, ARRAY ['spring'], ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Магева', 'soybean', 'Соя', 10.0, 35.0, 120, 0.35, 1.0, ARRAY ['spring'], ARRAY ['open_ground'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Лакомка', 'sunflower', 'Подсолнечник', 8.0, 35.0, 105, 0.25, 1.6, ARRAY ['spring'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Оливер', 'sunflower', 'Подсолнечник', 8.0, 35.0, 110, 0.3, 1.7, ARRAY ['spring'],
...
INSERT INTO public.growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity,
                       yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description,
                       water_requirement, light_requirement, phenophase_gdd, seeding_rates)
VALUES (gen_random_uuid(), 'Безостая 1', 'wheat', 'Пшеница', 3.0, 28.0, 280, 0.6, 1.0, ARRAY ['autumn'],
        ARRAY ['open_ground'],
       ...
       (gen_random_uuid(), 'Саратовская 29', 'wheat', 'Пшеница', 3.0, 30.0, 100, 0.5, 0.9, ARRAY ['spring'],
        ARRAY ['open_ground'],
...
INSERT INTO growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity, yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description, water_requirement, light_requirement, phenophase_gdd, seeding_rates) VALUES

                                                                                                                                                                                                                                                                                           (gen_random_uuid(), 'Нандрин F1', 'carrot', 'Морковь', 5.0, 25.0, 100, 8.0, 0.3, ARRAY['spring', 'summer'], ARRAY['open_ground'],
                                                                                                                                                                                                                                                                                            '{"root_weight": "150-200g", "root_color": "оранжевый", "root_shape": "цилиндрический", "use": "свежая, хранение"}',
                                                                                                                                                                                                                                                                                            'Гибрид голландской селекции с высоким содержанием каротина',
                                                                                                                                                                                                                                                                                            '{"daily_need_min": 2.5, "daily_need_opt": 4.0, "critical_phases": ["BBCH-51", "BBCH-71"]}',
                                                                                                                                                                                                                                                                                            '{"lux_min": 4000, "lux_opt": 20000, "lux_max": 35000, "day_length_opt": 14, "photoperiod_type": "long_day", "critical_phases": ["BBCH-19", "BBCH-51"]}',
                                                                                                                                                                                                                                                                                            '[{"code": "BBCH-10", "gdd_required": 60}, {"code": "BBCH-19", "gdd_required": 180}, {"code": "BBCH-51", "gdd_required": 350}, {"code": "BBCH-61", "gdd_required": 500}, {"code": "BBCH-71", "gdd_required": 650, "is_critical": true}, {"code": "BBCH-89", "gdd_required": 850}]',
                                                                                                                                                                                                                                                                                            '{"open_ground": {"growing_type": "open_ground", "row_spacing": 0.3, "plant_spacing": 0.05, "sowing_depth": 1.5, "germination_rate": 80, "safety_factor": 1.25}}'),

                                                                                                                                                                                                                                                                                           (gen_random_uuid(), 'Шантане', 'carrot', 'Морковь', 5.0, 25.0, 110, 7.0, 0.35, ARRAY['spring', 'summer'], ARRAY['open_ground'],
                                                                                                                                                                                                                                                                                            '{"root_weight": "100-150g", "root_color": "оранжевый", "root_shape": "конический", "use": "универсальный"}',
                                                                                                                                                                                                                                                                                            'Популярный сорт с отличной лежкостью',
                                                                                                                                                                                                                                                                                            '{"daily_need_min": 2.5, "daily_need_opt": 4.0, "critical_phases": ["BBCH-51", "BBCH-71"]}',
                                                                                                                                                                                                                                                                                            '{"lux_min": 4000, "lux_opt": 20000, "lux_max": 35000, "day_length_opt": 14, "photoperiod_type": "long_day", "critical_phases": ["BBCH-19", "BBCH-51"]}',
                                                                                                                                                                                                                                                                                            '[{"code": "BBCH-10", "gdd_required": 65}, {"code": "BBCH-19", "gdd_required": 190}, {"code": "BBCH-51", "gdd_required": 370}, {"code": "BBCH-61", "gdd_required": 520}, {"code": "BBCH-71", "gdd_required": 680, "is_critical": true}, {"code": "BBCH-89", "gdd_required": 900}]',
                                                                                                                                                                                                                                                                                            '{"open_ground": {"growing_type": "open_ground", "row_spacing": 0.3, "plant_spacing": 0.06, "sowing_depth": 1.5, "germination_rate": 78, "safety_factor": 1.28}}');
...
INSERT INTO growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity, yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description, water_requirement, light_requirement, phenophase_gdd, seeding_rates) VALUES
                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                           (gen_random_uuid(), 'Детройт', 'beetroot', 'Свекла', 5.0, 25.0, 90, 6.0, 0.3, ARRAY['spring', 'summer'], ARRAY['open_ground'],
                                                                                                                                                                                                                                                                                            '{"root_weight": "150-250g", "root_color": "бордовый", "root_shape": "округлый", "use": "универсальный"}',
                                                                                                                                                                                                                                                                                            'Скороспелый сорт с темно-красной мякотью без колец',
                                                                                                                                                                                                                                                                                            '{"daily_need_min": 3.0, "daily_need_opt": 5.0, "critical_phases": ["BBCH-51", "BBCH-71"]}',
                                                                                                                                                                                                                                                                                            '{"lux_min": 5000, "lux_opt": 22000, "lux_max": 38000, "day_length_opt": 14, "photoperiod_type": "long_day", "critical_phases": ["BBCH-19", "BBCH-51"]}',
                                                                                                                                                                                                                                                                                            '[{"code": "BBCH-10", "gdd_required": 55}, {"code": "BBCH-19", "gdd_required": 170}, {"code": "BBCH-51", "gdd_required": 320}, {"code": "BBCH-61", "gdd_required": 460}, {"code": "BBCH-71", "gdd_required": 600, "is_critical": true}, {"code": "BBCH-89", "gdd_required": 800}]',
                                                                                                                                                                                                                                                                                            '{"open_ground": {"growing_type": "open_ground", "row_spacing": 0.4, "plant_spacing": 0.1, "sowing_depth": 2.5, "germination_rate": 85, "safety_factor": 1.2}}'),

                                                                                                                                                                                                                                                                                           (gen_random_uuid(), 'Цилиндра', 'beetroot', 'Свекла', 5.0, 25.0, 100, 7.0, 0.35, ARRAY['spring', 'summer'], ARRAY['open_ground'],
                                                                                                                                                                                                                                                                                            '{"root_weight": "200-300g", "root_color": "бордовый", "root_shape": "цилиндрический", "use": "консервирование"}',
                                                                                                                                                                                                                                                                                            'Сорт с цилиндрическими корнеплодами, удобными для переработки',
                                                                                                                                                                                                                                                                                            '{"daily_need_min": 3.0, "daily_need_opt": 5.0, "critical_phases": ["BBCH-51", "BBCH-71"]}',
                                                                                                                                                                                                                                                                                            '{"lux_min": 5000, "lux_opt": 22000, "lux_max": 38000, "day_length_opt": 14, "photoperiod_type": "long_day", "critical_phases": ["BBCH-19", "BBCH-51"]}',
                                                                                                                                                                                                                                                                                            '[{"code": "BBCH-10", "gdd_required": 60}, {"code": "BBCH-19", "gdd_required": 180}, {"code": "BBCH-51", "gdd_required": 340}, {"code": "BBCH-61", "gdd_required": 480}, {"code": "BBCH-71", "gdd_required": 630, "is_critical": true}, {"code": "BBCH-89", "gdd_required": 850}]',
                                                                                                                                                                                                                                                                                            '{"open_ground": {"growing_type": "open_ground", "row_spacing": 0.4, "plant_spacing": 0.08, "sowing_depth": 2.5, "germination_rate": 82, "safety_factor": 1.22}}');
-- ============================================
-- Сорта перца
-- ============================================
...
INSERT INTO growing_varieties (id, name, species_key, species_name, base_temperature, max_temperature, days_to_maturity, yield_potential, plant_height, recommended_seasons, growing_types, characteristics, description, water_requirement, light_requirement, phenophase_gdd, seeding_rates) VALUES
                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                           (gen_random_uuid(), 'Калифорнийское чудо', 'pepper', 'Перец', 10.0, 30.0, 110, 7.0, 0.6, ARRAY['spring', 'summer'], ARRAY['open_ground', 'greenhouse'],
                                                                                                                                                                                                                                                                                            '{"fruit_weight": "150-200g", "fruit_color": "красный", "fruit_shape": "кубовидный", "use": "салатный"}',
                                                                                                                                                                                                                                                                                            'Классический сорт сладкого перца с толстыми стенками',
                                                                                                                                                                                                                                                                                            '{"daily_need_min": 2.5, "daily_need_opt": 4.5, "critical_phases": ["BBCH-61", "BBCH-71"]}',
                                                                                                                                                                                                                                                                                            '{"lux_min": 6000, "lux_opt": 25000, "lux_max": 45000, "day_length_opt": 12, "photoperiod_type": "day_neutral", "critical_phases": ["BBCH-51", "BBCH-61"]}',
                                                                                                                                                                                                                                                                                            '[{"code": "BBCH-10", "gdd_required": 110}, {"code": "BBCH-19", "gdd_required": 300}, {"code": "BBCH-51", "gdd_required": 550}, {"code": "BBCH-61", "gdd_required": 750, "is_critical": true}, {"code": "BBCH-71", "gdd_required": 900, "is_critical": true}, {"code": "BBCH-81", "gdd_required": 1150}, {"code": "BBCH-89", "gdd_required": 1350}]',
                                                                                                                                                                                                                                                                                            '{"open_ground": {"growing_type": "open_ground", "row_spacing": 0.6, "plant_spacing": 0.4, "sowing_depth": 1.5, "germination_rate": 85, "safety_factor": 1.18}}'),

                                                                                                                                                                                                                                                                                           (gen_random_uuid(), 'Оранжевое чудо', 'pepper', 'Перец', 10.0, 30.0, 115, 8.0, 0.55, ARRAY['spring', 'summer'], ARRAY['greenhouse'],
                                                                                                                                                                                                                                                                                            '{"fruit_weight": "180-220g", "fruit_color": "оранжевый", "fruit_shape": "кубовидный", "use": "салатный"}',
                                                                                                                                                                                                                                                                                            'Сорт с яркими оранжевыми плодами, богатыми бета-каротином',
                                                                                                                                                                                                                                                                                            '{"daily_need_min": 2.5, "daily_need_opt": 4.5, "critical_phases": ["BBCH-61", "BBCH-71"]}',
                                                                                                                                                                                                                                                                                            '{"lux_min": 6000, "lux_opt": 25000, "lux_max": 45000, "day_length_opt": 12, "photoperiod_type": "day_neutral", "critical_phases": ["BBCH-51", "BBCH-61"]}',
                                                                                                                                                                                                                                                                                            '[{"code": "BBCH-10", "gdd_required": 115}, {"code": "BBCH-19", "gdd_required": 310}, {"code": "BBCH-51", "gdd_required": 570}, {"code": "BBCH-61", "gdd_required": 770, "is_critical": true}, {"code": "BBCH-71", "gdd_required": 920, "is_critical": true}, {"code": "BBCH-81", "gdd_required": 1180}, {"code": "BBCH-89", "gdd_required": 1400}]',
                                                                                                                                                                                                                                                                                            '{"greenhouse": {"growing_type": "greenhouse", "row_spacing": 0.6, "plant_spacing": 0.45, "sowing_depth": 1.5, "germination_rate": 88, "safety_factor": 1.15}}'),

                                                                                                                                                                                                                                                                                           (gen_random_uuid(), 'Чили острый', 'pepper', 'Перец', 12.0, 32.0, 100, 3.0, 0.5, ARRAY['spring', 'summer'], ARRAY['open_ground', 'greenhouse'],
                                                                                                                                                                                                                                                                                            '{"fruit_weight": "5-10g", "fruit_color": "красный", "fruit_shape": "стручковидный", "use": "специи", "sharpness": "очень острый"}',
                                                                                                                                                                                                                                                                                            'Острый перец для использования в качестве специи',
                                                                                                                                                                                                                                                                                            '{"daily_need_min": 2.0, "daily_need_opt": 3.5, "critical_phases": ["BBCH-61", "BBCH-71"]}',
                                                                                                                                                                                                                                                                                            '{"lux_min": 6000, "lux_opt": 28000, "lux_max": 50000, "day_length_opt": 12, "photoperiod_type": "day_neutral", "critical_phases": ["BBCH-51", "BBCH-61"]}',
                                                                                                                                                                                                                                                                                            '[{"code": "BBCH-10", "gdd_required": 105}, {"code": "BBCH-19", "gdd_required": 280}, {"code": "BBCH-51", "gdd_required": 520}, {"code": "BBCH-61", "gdd_required": 700, "is_critical": true}, {"code": "BBCH-71", "gdd_required": 850, "is_critical": true}, {"code": "BBCH-81", "gdd_required": 1080}, {"code": "BBCH-89", "gdd_required": 1300}]',
                                                                                                                                                                                                                                                                                            '{"open_ground": {"growing_type": "open_ground", "row_spacing": 0.5, "plant_spacing": 0.3, "sowing_depth": 1.0, "germination_rate": 85, "safety_factor": 1.2}}');
-- ============================================
-- ПРОВЕРКА ИМПОРТА
-- ============================================
